(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../parser/cssNodes", "../parser/cssSymbolScope", "../languageFacts/facts", "../utils/strings", "vscode-languageserver-types", "vscode-nls", "../utils/objects"], factory);
    }
        ...
        CSSCompletion.prototype.getPropertyProposals = function (declaration, result) {
            ...
            properties.forEach(function (entry) {
                ...
                var item = {
                    ...
                    tags: isDeprecated(entry) ? [vscode_languageserver_types_1.CompletionItemTag.Deprecated] : [],
        ...
        CSSCompletion.prototype.getVariableProposals = function (existingNode, result) {
            ...
            for (var _i = 0, symbols_1 = symbols; _i < symbols_1.length; _i++) {
                ...
                if (typeof completionItem.documentation === 'string' && isColorString(completionItem.documentation)) {
                    completionItem.kind = vscode_languageserver_types_1.CompletionItemKind.Color;
                }
        ...
        CSSCompletion.prototype.getCompletionRange = function (existingNode) {
            if (existingNode && existingNode.offset <= this.offset && this.offset <= existingNode.end) {
                ...
                if (start.line === end.line) {
                    return vscode_languageserver_types_1.Range.create(start, end); // multi line edits are not allowed
                }
            }
