...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "vscode-languageserver-types", "vscode-nls", "../parser/cssNodes", "../parser/cssSymbolScope", "../languageFacts/facts", "../utils/strings"], factory);
    }
            ...
            stylesheet.accept(function (node) {
                ...
                if (node instanceof nodes.Selector) {
                    ...
                    if (mediaList instanceof nodes.Medialist) {
                        ...
                        entry.kind = vscode_languageserver_types_1.SymbolKind.Module;
                    }
                }
                if (entry.name) {
                    entry.location = vscode_languageserver_types_1.Location.create(document.uri, getRange(locationNode, document));
